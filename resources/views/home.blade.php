		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 object-non-visible" data-animation-effect="fadeIn">
					<h1 class="text-center">We are <span class="txt-rotate" data-period="2000" data-rotate='["simple.", "creative.", "developers.", "nerdy."]'></span>
					</h1>
					...
					<div class="col-sm-4 col-md-4 col-xs-12">
						<div class="footer-content">
							...
							<ul class="social-links">
								<a href="https://www.linkedin.com/in/kccemsr/" target="_blank">
									<li class="linkedin"><i class="fa fa-linkedin"></i></li>
								</a>
								<a href="https://www.facebook.com/socialinfo.kc.1/" target="_blank">
									<li class="facebook"><i class="fa fa-facebook"></i></li>
								</a>
								<a href="https://twitter.com/kccemsr_social/" target="_blank">
									<li class="twitter"><i class="fa fa-twitter"></i></li>
								</a>
								<a href="https://www.instagram.com/kccemsr_social/" target="_blank">
									<li class="instagram"><i class="fa fa-instagram"></i></li>
								</a>
								<a href="https://www.youtube.com/channel/UCoWQSD-KlLD47LpqiSkDZkQ/" target="_blank">
			...
			<div class="modal-content">
				<div class="modal-body">
					...
					<div class="text-center">
						<img src="/images/splash_banner.jpg" />
					</div>
