				...
				<nav class="navbar navbar-default" role="navigation">
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse scrollspy smooth-scroll" id="navbar-collapse-1">
							<ul class="nav navbar-nav">
								...
								<li class="{{$menu_item=='about'?'active':''}} sub-menu-parent"><a href="#">About</a>
									<ul class="sub-menu">
										...
										<li><a href="{{asset('files/iso_certification.pdf')}}" target="_blank">ISO Certification</a></li>
								...
								<li class=" sub-menu-parent"><a href="#">Exam</a>
									<ul class="sub-menu">
										...
										<li><a href="https://drive.google.com/drive/folders/1I3l7YZc-44QQKfR28porCD9mMXa8Nk4z?usp=sharing">Sample Question Paper for Dec 200 Exam</a></li>
							...
							<li class="{{$menu_item=='quarantine-story'?'active':''}} sub-menu-parent"><a href="{{route('quarantine-story')}}">My KC Quarantine Story</a></li>
							{{-- <li><a href="/#contact">Contact Us</a></li> --}}
						</ul>
					</div>
