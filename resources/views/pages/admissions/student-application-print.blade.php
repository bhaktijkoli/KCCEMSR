	...
	<div class="container">
		...
		<form id="form-admission" method="post" class="grid-form" enctype="multipart/form-data">
			...
			<fieldset>
				...
				<div data-row-span="4">
					<div data-field-span="1">
						<img src="{{Storage::url($data->image)}}" alt="" style="width: 100px;height: 120px">
					</div>
				</div>
			</fieldset>
			@endif
			...
			<fieldset>
				...
				@if (isset($data->hscChemistry))	
				<div data-row-span="5">
					<div data-field-span="1" style="height: 55px;">
						<h2 class="form-center-relative" style="bottom:0px">Chemistry</h2>
					</div>
					<div data-field-span="1" style="height: 55px;">
						<label>Marks Obtained (HSC)*</label>
						<p>{{$data->hscChemistry}}</p>
					</div>
					<div data-field-span="1" style="height: 55px;">
						<label>Maximum Marks (HSC)*</label>
						<p>{{$data->hscChemistryMax}}</p>
					</div>
					<div data-field-span="1" style="height: 55px;">
						<label>Marks Obtained(CET)*</label>
						<p>{{$data->cetChemistry}}</p>
					</div>
					<div data-field-span="1" style="height: 55px;">
						<label>Maximum Marks(CET)*</label>
						<p>{{$data->cetChemistryMax}}</p>
					</div>
				</div>
				@endif
				@if (isset($data->hscBiology))	
				<div data-row-span="5">
					<div data-field-span="1" style="height: 55px;">
						<h2 class="form-center-relative" style="bottom:0px">Biology</h2>
					</div>
					<div data-field-span="1" style="height: 55px;">
						<label>Marks Obtained (HSC)*</label>
						<p>{{$data->hscBiology}}</p>
					...
					<div data-field-span="1" style="height: 55px;">
						<label>Maximum Marks(CET)*</label>
						<p>{{$data->cetBiologyMax}}</p>
					</div>
				</div>
				@endif
				@if (isset($data->hscVocational))	
				<div data-row-span="5">
					<div data-field-span="1" style="height: 55px;">
						<h2 class="form-center-relative" style="font-size: 2.1rem;bottom:0px">Vocational/Bifocal</h2>
					</div>
					<div data-field-span="1" style="height: 55px;">
						<label>Marks Obtained (HSC)*</label>
						<p>{{$data->hscVocational}}</p>
					</div>
					<div data-field-span="1" style="height: 55px;">
						<label>Maximum Marks (HSC)*</label>
						<p>{{$data->hscVocationalMax}}</p>
					</div>
					<div data-field-span="1" style="height: 55px;">
						<label>Marks Obtained(CET)*</label>
						<p>{{$data->cetVocational}}</p>
					</div>
					<div data-field-span="1" style="height: 55px;">
						<label>Maximum Marks(CET)*</label>
						<p>{{$data->cetVocationalMax}}</p>
					</div>
				</div>
				@endif
			</fieldset>
