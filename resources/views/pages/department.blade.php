	...
	<div class="col-md-12">
		<div class="card">
			<ul class="nav nav-tabs" role="tablist">
				...
				<li role="presentation"><a href="#labs" aria-controls="profile" role="tab" data-toggle="tab">Labs</a></li>
				<li role="presentation"><a href="#dptAct" aria-controls="home" role="tab" data-toggle="tab">Activities</a></li>
				<li role="presentation"><a href="#stuAch" aria-controls="profile" role="tab" data-toggle="tab">Student's Achievement</a></li>
				<li role="presentation"><a href="#innovativeMethods" aria-controls="profile" role="tab" data-toggle="tab">Innovative Methods</a></li>
			...
			<div role="tabpanel" class="tab-pane" id="innovativeMethods">
				<h3>Innovative Methods</h3>
				@php
				$methods = File::allFiles(public_path('public/departments/innovate_methods/' . $dep->url));
				@endphp
				<ul>
