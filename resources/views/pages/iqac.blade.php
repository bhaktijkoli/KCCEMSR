	...
	<div class="container main-content-sub">
		...
		<div class="col-sm-8 col-md-8">
			<div class="tab-content">
				...
				<div id="audit-statements" class="{{$action=='audit-statements'?'tab-pane fade in active':'tab-pane fade in'}}">
					<h3>Audit Statements</h3>
			         @php
							$ktquestions = File::allFiles(public_path('public/iqac/audit-statements'));
						@endphp
						<ul>
