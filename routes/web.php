...
Route::middleware([MaintenanceCheck::class])->group(function () {
  ...
  Route::get('/naac/AQAR-2019-20', 'AboutController@getAQAR201920')->name('naac-AQAR-2019-20');
  ...
  Route::get('/naac/academic-calendar-2018-19', 'AboutController@getAcademicCalender201819')->name('naac-academic-calendar-2018-19');
  ...
  Route::get('/admissions/fees-details', 'AdmissionsController@getFeesDetails')->name('admissions-fees');
...
Route::prefix('admin')->group(function () {
  ...
  Route::get('/admission/forms/export', 'Admin\DashboardController@admissionFormsExport')->name("admin_admission_form.export");
