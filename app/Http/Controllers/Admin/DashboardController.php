      ...
      $excel->sheet('Students', function ($sheet) {
        ...
        foreach (\App\Admission::latest()->get() as $admission) {
          ...
          $sheet->appendRow(array(
            ...
            strtoupper($data->cphone),
            strtoupper($data->cparent),
            ...
            strtoupper($data->sscMarks . '/' . $data->sscMax),
            strtoupper($data->sscBoard),
            strtoupper($data->sscYear),
            strtoupper($data->hscMarks . '/' . $data->hscMax),
            strtoupper($data->hscBoard),
            strtoupper($data->hscYear),
