...
class Committee extends Model
{
  ...
  public static function getAll() {
    $committees = collect([
      ...
      (object)["name"=>"Industrial Visit", "url"=>"industrial_visit"],
      (object)["name"=>"Industrial Activities", "url"=>"industrial_activities"],
